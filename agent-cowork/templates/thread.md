...
v1.8.0：thread 集中單檔，responder 只 append 不另開新檔
v1.8.0 新增：HEARTBEAT-snippet 改 /goal-driven（本檔與 /goal 設計無關）
v1.7.0 起：維護者（per host 1 個）會另跑 §6.6 全域摘要匯報，跟本檔獨立
...
*<sender> · <時間> Asia/Taipei · 發起 thread 至 agent-cowork · v1.8.0*
